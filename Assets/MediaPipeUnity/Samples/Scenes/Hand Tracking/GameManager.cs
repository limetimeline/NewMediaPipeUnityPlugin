...
{
  public static Mediapipe.NormalizedLandmarkList handLandmarksInfo;
...
// Mediapipe.NormalizedLandmarkList.Landmark의 요소 추출 : Mediapipe.NormalizedLandmarkList.Landmark.X, .Y, .Z
  ...
  public static Mediapipe.ClassificationList handednessInfo;
// Mediapipe.ClassificationList의 형식 : { "classification": [ { "index": 0, "score": 0.850634634, "label": "Left" } ] }
// Mediapipe.ClassificationList.Classification의 index : Mediapipe.ClassificationList.Classification[0] - 하나 밖에 없다.
// Mediapipe.ClassificationList.Classification[0]의 요소 추출 : Mediapipe.ClassificationList.Classification[0].Index, .Score, .Label
  ...
  /* Handedness 추출 */
    if(handednessInfo != null){
          Debug.Log("<Handedness>");
          Debug.Log(handednessInfo.Classification[0].Label);
    }
  }
